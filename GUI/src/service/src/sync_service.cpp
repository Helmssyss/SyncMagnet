...
void SaveFileData(const int& bufferSize, const char* fileName,bool allowMultiple){
    std::ofstream file;
...
void HandleFileProcess(char* buffer, int &bufferSize, bool saveMultipleFile){
    if (!saveMultipleFile){
